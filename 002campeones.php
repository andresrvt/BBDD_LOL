...
if ($listaChamp) {
  foreach ($listaChamp as $champs) {
    ...
    echo "<button type='button' class='btn btn-danger m-2' data-toggle='modal' data-target='#theModal$champs[id]'>Borrar</button><br><br></div>";
    echo "<div class='modal fade' id='theModal$champs[id]' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
        <div class='modal-dialog' role='document'>
          <div class='modal-content'>
            ...
            <div class='modal-footer'>
              ...
              <a href='delete.php?id=$champs[id]'><Borrar type='button' class='btn btn-danger m-2'>Borrar campeón</button></a>
            </div>
          </div>
        </div>
      </div>";
